...
mod tests {
    ...
    #[test]
    fn to_roman_basic() {
        assert_eq!(to_roman(1), Some("I".into()));
        assert_eq!(to_roman(4), Some("IV".into()));
        assert_eq!(to_roman(9), Some("IX".into()));
    }
    #[test]
    fn to_roman_complex() {
        assert_eq!(to_roman(1994), Some("MCMXCIV".into()));
        assert_eq!(to_roman(3888), Some("MMMDCCCLXXXVIII".into()));
    }
    #[test]
    fn to_roman_invalid() {
