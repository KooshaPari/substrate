...
pub fn parse_question(
    buf: &[u8],
    mut offset: usize,
) -> Result<(DnsQuestion, usize), DnsParseError> {
...
mod tests {
    ...
    fn parse_record_basic() {
        ...
        let mut buf = vec![
            3, b'b', b'a', b'r', 0, 0x00, 0x01, 0x00, 0x01, 0, 0, 0, 60, 0, 4, 1, 2, 3, 4,
        ];
    ...
    #[test]
    fn parse_name_bad_label_length() {
