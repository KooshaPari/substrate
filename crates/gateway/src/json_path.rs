...
mod tests {
    ...
    #[test]
    fn string_value() {
        assert_eq!(find_value(r#"{"name":"alice"}"#, "name"), Some("alice"));
    }
    #[test]
    fn number_value() {
        assert_eq!(find_value(r#"{"age":30}"#, "age"), Some("30"));
    }
    #[test]
    fn bool_value() {
        assert_eq!(find_value(r#"{"active":true}"#, "active"), Some("true"));
    }
    #[test]
    fn missing() {
        assert_eq!(find_value(r#"{"name":"alice"}"#, "age"), None);
    }
    #[test]
    fn count_multiple() {
        assert_eq!(count_keys(r#"{"id":1,"name":"a","id":2}"#, "id"), 2);
    }
}
