pub fn parse(s: &str) -> Option<ParsedUrl> {
    ...
    Some(ParsedUrl { scheme: scheme.to_string(), host, port, path: path.to_string() })
}
...
mod tests {
    ...
    #[test] fn build_with_port() {
        assert_eq!(build_url("https", "x.com", Some(443), "/a"), "https://x.com:443/a");
    }
    #[test] fn build_no_port() {
